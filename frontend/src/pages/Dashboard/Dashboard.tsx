        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-200">
              <th className="text-xs text-gray-400 font-medium text-left py-2 px-0">CIDADE</th>
              <th className="text-xs text-gray-400 font-medium text-center py-2">VENDEDORES</th>
              <th className="text-xs text-gray-400 font-medium text-center py-2">EM ESTOQUE</th>
              <th className="text-xs text-gray-400 font-medium text-center py-2">TOTAL VENDIDO</th>
            </tr>
          </thead>
          <tbody>
            {cidades.map((item) => (
              <tr key={item.cidade} className="border-b border-gray-100">
                ...
                <td className="text-sm text-gray-500 text-center py-4">{item.vendedores}</td>
                <td className="text-sm text-gray-500 text-center py-4">{item.emEstoque}</td>
                <td className="text-sm text-green-500 font-medium text-center py-4">{item.totalVendido}</td>
              </tr>
            ))}
          </tbody>
        </table>
